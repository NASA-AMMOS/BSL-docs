...
Separately from the bundle-related interactions described in <<sec-api-bundle>>, the BPA and BSL interact through several other interfaces related to infrastructure needs.
