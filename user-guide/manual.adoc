...
plantuml::static/bpa-associations.puml[format=png,width=60mm]
...
plantuml::static/bsl-breakdown.puml[format=png,width=60mm]
...
plantuml::static/secop-associations.puml[format=png,width=100mm]
...
plantuml::static/secondary-associations.puml[format=png,width=60mm]
...
plantuml::static/bundle-workflow.puml[format=png,width=100mm]
