...
Maximum length of sample policy provider rule description. When initializing a policy rule, only characters at position `0` through `POLICY_RULE_DESCRIPTION_MAX_STRLEN-1` are copied.
