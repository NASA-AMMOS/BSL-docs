...
1. `BSL_API_QuerySecurity` covers steps 1 through 6 above.
...
2. `BSL_API_ApplySecurity` covers steps 7 through 18 above.
The function first executes each security operation with its associated security context.
Next, the policy providers will finalize over the results.
