...
`policyrule_set`::
 Each `policyrule` should be included in a JSON list, which is the value of an attribute `policyrule_set`. An example format of JSON with two policy rules is as follows:
