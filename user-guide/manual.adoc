...
The Mock BPA communicates with "the outside" at each interaction point using UDP socket binds configured by command options explained in detail in <<bsl-main-api>>.
