...
The length of an Authentication Tag for BCBs as specified by RFC 9173 <<RFC9173>>.
...
The default initialization vector length as specified by RFC 9173 <<RFC9173>>.
...
DATA_QUEUE_SIZE - 100::
Size of the MockBPA queues for each thread.
