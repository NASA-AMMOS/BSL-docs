...
This implementation corresponds to the shared library `bsl_default_sc` as explained in the <<bsl-product-guide>>.
...
This implementation corresponds to the shared library `bsl_example_pp` as explained in the <<bsl-product-guide>>.
...
This implementation corresponds to the executable `bsl-mock-bpa` and shared library `bsl_mock_bpa` as explained in the <<bsl-product-guide>>.
