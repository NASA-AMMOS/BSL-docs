...
The BSL is made to interact with its environment (BPA, libraries, host OS, _etc._) through function calls into the BSL library and out of it based on a <<C99>> Application Programming Interface (API) from header declarations and corresponding Application Binary Interface (ABI) for compiled libraries.
